...
if ($result = mysql_query($sql2))
{
	if (@mysql_num_rows($result) > 0)
	{
		...
		{
			$userlist .= '<tr class="style2"><td>'.$row['lastname'].', '.$row['firstname'].'</td><td>'.$row['username'].'</td><td>'.str_chop($row['email'],20).'</td><td><a href="./userinfo.php?user='.$row['username'].'"><img src="../images/info15px.gif" alt="Info" border="0" title="More Information" /></a> <a href="./bulkemail.php?user='.$row['username'].'"><img src="../images/mail15px.gif" alt="Email" border="0" title="Email" /></a> <a href="#" onclick="deleteuser(\''.$row['username'].'\')"><img src="../images/delete15px.gif" alt="Remove" border="0" title="Remove" /></a></tr>'."\n";
		}
	}
	else
	{
...
<title>Deadlock - Manager Users</title>
...
<table width="549" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="20" colspan="2" class="style2"><strong><a href="./index.php">Top</a>: Manage Users</strong></td>
  </tr>
  <tr>

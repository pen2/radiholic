...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','-','Bold','Italic','Underline','StrikeThrough','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Subscript','Superscript','-','OrderedList','UnorderedList','-','Link','Unlink','-','Image','-','Table','-','Undo'],
	['FontFormat','FontName','FontSize','-','TextColor','BGColor','-','FitWindow','-','About']
] ;

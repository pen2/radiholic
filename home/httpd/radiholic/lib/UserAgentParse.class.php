...
NOTICE: This class was modified on June 24 2006 for PHP Deadlock User
Management System to allow it to parse any given user agent string.
...
class browser{
    ...
    function browser($agent){
        ...
        if (eregi("win", $agent))
            $bd['platform'] = "Windows";
        elseif (eregi("android", $agent)) /* pen2 added */
            $bd['platform'] = "Android";
